...
function V1_HeroSection() {
  ...
  return (
    <div className="flex flex-col gap-10 items-center shrink-0 min-w-[1440px] w-full min-h-screen relative">
      ...
      />
      <div
        className="absolute top-[300px] inset-0 bg-gradient-to-b from-transparent via-black to-[#03002A]"
        style={{
          background:
            "linear-gradient(180deg, rgba(0, 0, 0, 0.00) 0%, #000 40%, #03002A 80%)",
        }}
      />
      <div className="relative z-20 flex flex-col justify-center items-center self-stretch gap-4 px-[120px] mt-40">
        <TypingText
          key={`first-${reset}`}
      ...
      <div className="flex flex-col w-[344px] self-center items-center gap-10 mt-20 z-20">
        <span
          className={`text-white text-center ${rethinkSans.className} text-[24px] font-semibold leading-[2] uppercase`}
        >
          Don&apos;t wait for Permission
        </span>
        <BounceAnimation className="flex flex-col gap-4 w-full">
      ...
      <div className="z-20 bg-[#F1F3F7] mt-auto w-full">
