...
export default function Footer() {
  return (
    <footer
      className={`min-w-[1440px] shrink-0 bg-[#03002A] bg-[url('/bg/bestia_bg.svg')] bg-cover bg-center ${rethinkSans.className}`}
    >
      <div className="flex px-0 pt-[172px] pb-8 flex-col items-start gap-[116px] shrink-0">
        <div className="flex px-[200px] justify-center items-center gap-[60px] self-stretch">
          {/* 좌측 영역 */}
